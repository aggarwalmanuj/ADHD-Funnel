        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 16 : 20 }}>
          ...
          <FadeIn delay={0.1}>
            <div style={{ borderRadius: 12, padding: isMobile ? "28px 24px" : "40px", background: "var(--bg-card)", border: "1px solid var(--border)", height: "100%", boxSizing: "border-box" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ width: 38, height: 38, borderRadius: "50%", background: "linear-gradient(135deg, var(--accent), #7a5520)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 700, color: "var(--bg)", flexShrink: 0, fontFamily: "var(--font-body)" }}>N</div>
                <div>
          ...
          <FadeIn delay={0.2}>
            <div style={{ borderRadius: 12, padding: isMobile ? "28px 24px" : "40px", background: "var(--bg-card)", border: "1px solid var(--border)", height: "100%", boxSizing: "border-box" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ width: 38, height: 38, borderRadius: "50%", background: "linear-gradient(135deg, var(--accent), #7a5520)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 700, color: "var(--bg)", flexShrink: 0, fontFamily: "var(--font-body)" }}>B</div>
                <div>
